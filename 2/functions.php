...
//Send mail with PHPMailer Class
function sendContactMail($name, $email, $subject, $deartment, $text)
{
    ...
    try {
      ...
      //Recipients
        ...
        $mail->addAddress('jackforrest738@gmail.com', 'ایمیل تماس با ما');     // Add a recipient
      // Content
      ...
      و محتوای برای بخش '.$deartment.' زیر ارسال شده است :<br><br>
      <strong>
      '.$text.'
      </strong>
      </div>
